                ...
                <div class='max-w-screen-md mx-auto'>
                    <div
                        ...
                        <div
                            ...
                            <div class='py-5 border-b border-gray-200 dark:border-gray-700'>
                                <p class='mb-2 text-gray-500 dark:text-gray-400'>
                                    The main difference is that the core components from Landwind are open source under the MIT license, whereas Tailwind UI is a paid product. Another difference is
                                    that Landwind relies on smaller and standalone components, whereas Tailwind UI offers sections of pages.
                                </p>
                                <p class='mb-2 text-gray-500 dark:text-gray-400'>
                                    However, we actually recommend using both Landwind, Landwind Pro, and even Tailwind UI as there is no technical reason stopping you from using the best of two
                                    worlds.
                                </p>
